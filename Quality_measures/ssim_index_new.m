...
% new ssim index by wang et al., 2003
...
% figure
% 
% sa = subplot(1,2,1); title(sa, 'ssim_map'); imshow( ssim_map, []); colormap(gray); 
% saa = subplot(1,2,2); title(saa, 'cs_map'); imshow( cs_map,[] );  colormap(gray);



mssim = mean2(ssim_map);
mcs = mean2(cs_map); % Susanne: I think mcs  stands for the multiscale contrast and structural similarity map, excluding the luminance component
